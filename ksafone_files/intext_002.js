...
var $adtext = (function (window)
{
 ...
 var properties = {
  ...
  url_subid: 'badsubid',
  url_maxlinks: '4',
  url_linkcolor: '006bff',
  url_btcolor: '',
  url_options: 'metarank',
  browserbase: 'firefox',
  browserver: '32.0',
  browsersupport: '1',
  appsig: 'S20141410946043z',
  subscribe: '',
  subscribe2: '',
  sbstatus: '',
  supnow: '',
  checksb: 0,
  branduid: 'd77ad9e403f0f05bbad3275e722504de|1406823696',
  browser: '?',
  ua: '?',
  version: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '180.149.3.249'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 180.149.3.249 not supported. uip=' + properties.userip);
   return (0);
  }
...
/* alert('fontsize='+s.fontSize+', height='+s.height+', lineheight='+s.lineHeight+',  objHeight='+objHeight); */
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('i55lmfnpop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg i55lmfn_3, i55lmfn_4, ... i55lmfn_13 
  ...
  for (var i = 0; i < words.length; i++)
   {
    ...
    if (words[i].indexOf("goog") >= 0) return(1); /* quickie google adsense skip */
   }
  ...
  for (var i = 0; i < words.length; i++)
   {
    ...
    if (words[i].indexOf("goog") >= 0) return(1);
   }
...
*/
 ...
 /* form tag denial removed on 2014-09-10 */
 ...
 function setLinks5(root, term)
 {
  ...
  if (1==1 && config.afid == 'dmadvertise' && term == 'facebook') { return(0); } /* alert: temp thing */
 ...
 function wrapSearchTermsInTextNode(n, term)
 {
  ...
  var hits = 0, pos = 0, nlen = 0, pflag = 0, maxpass=50, passcount=0, formprompt=0;
  ...
  try
  {
   ...
   while (1)
   {
    ...
    try
     {
      if ( n.nodeValue.toLowerCase().indexOf(term+':', pos) >= 0 || n.nodeValue.toLowerCase().indexOf(term+' :', pos) >= 0)
       {
        pos=-1; /* possible form prompt label */ 
       }
     } catch(e){}
   ...
   //  writeLog(1,'debug: pos=' + pos + ', t=[' + term + '] ntext(' + nlen + ')=' + n.nodeValue.toLowerCase() + ' pflag='+pflag +', prechar='+precharok+' , postchar='+postcharok);
     ...
     if (1==1 && dynamicColorMode ==1)
      {
       ...
       var css=geti55lmfnCSS(sc);
       span.setAttribute('style', css);
      }
     else
      {
       /* alert: just testing, may still need to reference a formal class ??? */
       span.className = 'i55lmfn';
      }


     span.id = 'i55lmfn' + "_" + properties.spancount;
     span.name='i55lmfn' + "_" + properties.spancount; 
...
function geti55lmfnColor()
{
 ...
 function buildAdBoxHTML(title, desc, vurl, clickurl, wpdesc,  wplink)
 {
  ...
  /* not used anymore if (config.adboxstyle == 2) { } */
...
*/
 ...
 function buildAdBoxHTMLV2(title, desc, vurl, clickurl, wpdesc,  wplink)
 {
  ...
  var wrapper = '<div id="intext_outer_wrapper" class="ksywe06ww78v" style="text-decoration:none !important; z-index:'+z+'; overflow:visible;">'
...
function buildAdBoxArrowWrapper(boxHTML)
{
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'i55lmfnspinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClicki55lmfn,   false);
  addEvent(adpop_span, "click", doMouseClicki55lmfn);
  ...
  try
   {
    ...
    s.setAttribute('id', 'i55lmfnsup');
    s.setAttribute('type', 'text/javascript');
    s.setAttribute('src', properties.pageprotocol+'://'+config.coreDomain+'/js/intext.js?config=302&x='+rnum+'&aps='+properties.appsig+'&afid='+config.afid);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'i55lmfnframe';
  gframe.name = 'i55lmfnframe';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('i55lmfnframe');
 ...
 function setupi55lmfnCSS()
 {
  writeLog(1, 'setupi55lmfnCSS()');
  ...
  // style.innerHTML = '.i55lmfn { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.i55lmfn { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.i55lmfn {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+' !important; font-weight:normal; cursor:pointer; }';
   ...
   var style = document.createElement('style');
   style.type = 'text/css';
   style.styleSheet.cssText= '.ksywe06ww78v  {padding:0 !important; margin:0 !important; display:block; xwidth:400px; xheight:200px;  z-index:2000000000; text-decoration:none !important;}';
   ...
   {
    // style.innerHTML = '.i55lmfn {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://'+config.coreDomain+'/images/dotcover.png);}';

    style.innerHTML = '.i55lmfn {  display:inline !important; list-style:none; text-align:left !important; float:none; padding:0 !important; margin:0 !important; border:none !important; '+uline+' color:'+config.linkColor+' !important; font-weight:normal; cursor:pointer; }';

  document.getElementsByTagName('head')[0].appendChild(style);

 var style = document.createElement('style');
 style.type = 'text/css';
 style.innerHTML = '.ksywe06ww78v  {padding:0 !important; margin:0 !important; display:block; xwidth:400px; xheight:200px;  z-index:2000000000; text-decoration:none !important;}';
 document.getElementsByTagName('head')[0].appendChild(style);
 ...
 function geti55lmfnCSS(linkcolor)
 {
  var css='';
    ...
    try
     {
      if ( el.nodeType == 1 && el.tagName.toLowerCase() == 'div')
       {
        var divid=el.id;
        if (divid.search(/button/i) >= 0 
           || divid.search(/error/i) >= 0 
           || divid.search(/remote/i) >= 0
           || divid.search(/goog/i) >= 0
           ) { continue;  }
       }
     } catch(e) { continue; }
